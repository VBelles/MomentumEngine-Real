...
CVertexDecl* CVertexDeclManager::createNew(const std::string& name,
	...
	for (UINT i = 0; i < numElements; ++i) {
		...
		case DXGI_FORMAT_R32_UINT:			 total_bytes += 4;     break;
		default:
...
bool CVertexDeclManager::create() {
	...
	}
	{
		...
		createNew("PosNUvUvTSkin", layout, ARRAYSIZE(layout));
	}
	{
		// Instance of a solid mesh, just the world matrix and an ID
		static D3D11_INPUT_ELEMENT_DESC layout[] = {
			...
			{ "TEXCOORD", 6, DXGI_FORMAT_R32_UINT, 0, 64, D3D11_INPUT_PER_VERTEX_DATA, 0 },    // id
		};
