...
static const std::string SOUND_PLAYER = "sound_player";
static const std::string FINAL_DOOR_CONTROLLER = "final_door_controller_trigger";
...
static const std::string PREFAB_DREIDEL_DUMMY = "data/prefabs/dreidel_dummy.prefab";
static const std::string PREFAB_GOLEM = "data/prefabs/gorila.prefab";
static const std::string PREFAB_GOLEM_DUMMY = "data/prefabs/gorila_dummy.prefab";
...
auto constexpr SOUND_CHRYSALIS_PUZZLE = "event:/INTERACTUABLE/hyrule_secret";
