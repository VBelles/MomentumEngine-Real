...
// This is a Handle manager which stores objects of type TObj
template< class TObj >
...
public:
	...
	TObj* getAddrFromHandle(CHandle h) {
		...
		// El handle es 'viejo', en esa entrada hay otro objeto ahora
		if (ed.current_age != h.getAge()) return nullptr;
