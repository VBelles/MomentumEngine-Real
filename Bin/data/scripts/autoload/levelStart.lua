function onLevelStart_game_state()
    ...
    -- -- Start murales -- --
        ...
        showDialog("There was a time when peace and magic reigned.", fontSize)
        ...
        wait(tiempoMuralVertical)
        showDialog("One day a seed fell from the sky and The Tree grew.", fontSize)
        waitCondition(isDialogHidden)
        ...
        wait(tiempoMuralVertical)
        showDialog("As the almighty entity appeared, the citizens prayed for a prosper future.", fontSize)
        waitCondition(isDialogHidden)
        ...
        wait(tiempoMuralVertical)
        showDialog("With it, other creatures appeared and new knowledge blossomed.", fontSize)
        waitCondition(isDialogHidden)
        ...
        wait(tiempoMuralVertical)
        showDialog("But it was known that their nature was full of envy and greed, and soon their friendship with The Tree's children turned into abuse and war.", fontSize)
        waitCondition(isDialogHidden)
