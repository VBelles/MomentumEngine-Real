function onLevelStart_game_state()
    ...
    -- -- Start murales -- --
        ...
        wait(tiempoMuralVertical)
        showDialog("But their nature was full of envy and greed, and soon their friendship with The Tree's children turned into abuse and war.", fontSize, false)
        wait(tiempoParaCancelarDialogo)
        setCancelableWithButton(true)
        waitCondition(isDialogHidden)
        ...
        wait(tiempoMuralVertical)
        showDialog("The battle lasted for hundreds of moons, and the citizens lost.", fontSize, false)
        wait(tiempoParaCancelarDialogo)
        setCancelableWithButton(true)
        waitCondition(isDialogHidden)
        ...
        wait(tiempoMuralVertical)
        showDialog("The prophecy explains: 'A flower will rise when the stars align and it will bring revenge to our species. From our ashes she will be born.' We pray for you now.", fontSize, false)
       wait(tiempoParaCancelarDialogo)
       setCancelableWithButton(true)
        waitCondition(isDialogHidden)
    -- -- End murales -- --
