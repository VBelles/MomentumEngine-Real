...
) : SV_Target
{
	...
	float stepLength = isHorizontal ? camera_inv_resolution.y : camera_inv_resolution.x;
	...
	float2 offset = isHorizontal ? float2(camera_inv_resolution.x,0.0) : float2(0.0,camera_inv_resolution.y);
